...
Since MLIR is written in C++ and Mathic in Rust, we are using [melior crate](https://crates.io/crates/melior) to have the necessary bindings. You can find a small intro to how the crate is used [here](https://edgl.dev/blog/mlir-with-rust/).
