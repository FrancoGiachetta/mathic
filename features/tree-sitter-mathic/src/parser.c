...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_top_decl] = STATE(94),
    [sym_imports_decls] = STATE(121),
    [sym_func_decl] = STATE(121),
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(162)] = 4206,
  [SMALL_STATE(163)] = 4216,
  [SMALL_STATE(164)] = 4226,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [16] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(215),
  [19] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(52),
  [22] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(213),
  [25] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(6),
  [28] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0),
  [30] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(199),
  [33] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(172),
  [36] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(182),
  [39] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(81),
  [42] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(80),
  [45] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(51),
  [48] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(90),
  [51] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(20),
  ...
  [101] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_primary, 1, 0, 0), SHIFT(193),
  ...
  [108] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_path_repeat1, 2, 0, 0), SHIFT_REPEAT(169),
  ...
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 2, 0, 10),
  [123] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 2, 0, 10),
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_primary, 2, 0, 0),
  [127] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_primary, 2, 0, 0),
  [129] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 17),
  [131] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 17), SHIFT_REPEAT(35),
  [134] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 17),
  [136] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 17), SHIFT_REPEAT(148),
  [139] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 17), SHIFT_REPEAT(193),
  ...
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 3, 0, 19),
  [162] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_call_expression_repeat1, 3, 0, 19),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 3, 0, 0),
  [166] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_call_expression_repeat1, 3, 0, 0),
  [168] = {.entry = {.count = 1, .reusable = false}}, SHIFT(123),
  [170] = {.entry = {.count = 1, .reusable = true}}, SHIFT(22),
  [172] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_stmt, 3, 0, 12),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_stmt, 3, 0, 12),
  ...
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_initializer, 1, 0, 0),
  ...
  [202] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_non_binary_expression, 1, 0, 0),
  [204] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_non_binary_expression, 1, 0, 0),
  [206] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_no_assign, 1, 0, 0),
  [208] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_no_assign, 1, 0, 0),
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 3, 0, 16),
  [212] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 3, 0, 16),
  [214] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_expression, 2, 0, 9),
  [216] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_expression, 2, 0, 9),
  [218] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 2, 0, 0),
  [220] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 2, 0, 0),
  [222] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_while_stmt, 3, 0, 12),
  [224] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_while_stmt, 3, 0, 12),
  [226] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_stmt, 1, 0, 0),
  [228] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stmt, 1, 0, 0),
  ...
  [234] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expr_stmt, 2, 0, 0),
  [236] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expr_stmt, 2, 0, 0),
  [238] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sym_decl, 5, 0, 20),
  [240] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sym_decl, 5, 0, 20),
  [242] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_for_stmt, 5, 0, 21),
  [244] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_for_stmt, 5, 0, 21),
  [246] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_stmt, 5, 0, 22),
  [248] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_stmt, 5, 0, 22),
  [250] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_var_decl, 7, 0, 25),
  [252] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_var_decl, 7, 0, 25),
  [254] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_for_stmt, 7, 0, 26),
  [256] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_for_stmt, 7, 0, 26),
  [258] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_struct_decl, 4, 0, 1),
  [260] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_decl, 4, 0, 1),
  [262] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_func_decl, 5, 0, 3),
  [264] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func_decl, 5, 0, 3),
  [266] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_struct_decl, 5, 0, 4),
  [268] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_decl, 5, 0, 4),
  [270] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_return_stmt, 3, 0, 13),
  [272] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_return_stmt, 3, 0, 13),
  [274] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_func_decl, 6, 0, 7),
  [276] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func_decl, 6, 0, 7),
  [278] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_func_decl, 6, 0, 8),
  [280] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func_decl, 6, 0, 8),
  [282] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_expression, 1, 0, 0), REDUCE(sym_expression_no_assign, 1, 0, 0),
  ...
  [295] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2, 0, 0), SHIFT_REPEAT(152),
  [298] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2, 0, 0), SHIFT_REPEAT(181),
  [301] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2, 0, 0), SHIFT_REPEAT(189),
  [304] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__type, 2, 0, 6),
  [306] = {.entry = {.count = 1, .reusable = true}}, SHIFT(25),
  [308] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__type, 1, 0, 2),
  [310] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [312] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_program, 1, 0, 0),
  [314] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__type, 4, 0, 0),
  [316] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__type, 5, 0, 0),
  [318] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_native_type, 1, 0, 0),
  [320] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment_expression, 1, 0, 0),
  [322] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_initializer, 2, 0, 0),
  [324] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression, 1, 0, 0),
  [326] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 3, 0, 14),
  [328] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 4, 0, 18),
  [330] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_init, 6, 0, 0),
  [332] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_init, 5, 0, 0),
  [334] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_path, 1, 0, 0),
  [336] = {.entry = {.count = 1, .reusable = true}}, SHIFT(109),
  [338] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_imports_decls, 3, 0, 0),
  ...
  [352] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_assignment_repeat1, 2, 0, 0),
  [354] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_assignment_repeat1, 2, 0, 0), SHIFT_REPEAT(193),
  [357] = {.entry = {.count = 1, .reusable = true}}, SHIFT(50),
  [359] = {.entry = {.count = 1, .reusable = true}}, SHIFT(193),
  [361] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_path_repeat1, 2, 0, 0), SHIFT_REPEAT(206),
  [364] = {.entry = {.count = 1, .reusable = true}}, SHIFT(68),
  [366] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_top_decl, 1, 0, 0),
  [368] = {.entry = {.count = 1, .reusable = true}}, SHIFT(206),
  [370] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_fields, 3, 0, 0),
  [372] = {.entry = {.count = 1, .reusable = true}}, SHIFT(162),
  [374] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_path, 3, 0, 0),
  [376] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_args_list, 1, 0, 0),
  [378] = {.entry = {.count = 1, .reusable = true}}, SHIFT(56),
  [380] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_list, 4, 0, 0),
  [382] = {.entry = {.count = 1, .reusable = true}}, SHIFT(191),
  [384] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_param_list_repeat1, 2, 0, 0),
  [386] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_param_list_repeat1, 2, 0, 0), SHIFT_REPEAT(191),
  [389] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_fields, 5, 0, 0),
  [391] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_struct_fields_repeat1, 2, 0, 0),
  [393] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_struct_fields_repeat1, 2, 0, 0), SHIFT_REPEAT(162),
  [396] = {.entry = {.count = 1, .reusable = true}}, SHIFT(136),
  [398] = {.entry = {.count = 1, .reusable = true}}, SHIFT(159),
  [400] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_fields, 4, 0, 0),
  [402] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_args_list, 2, 0, 0),
  [404] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_list, 3, 0, 0),
  [406] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_path, 6, 0, 0),
  [408] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_import_path_repeat1, 2, 0, 0),
  [410] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_import_path_repeat1, 2, 0, 0), SHIFT_REPEAT(159),
  [413] = {.entry = {.count = 1, .reusable = true}}, SHIFT(104),
  [415] = {.entry = {.count = 1, .reusable = true}}, SHIFT(173),
  [417] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_substitution_args, 3, 0, 23),
  [419] = {.entry = {.count = 1, .reusable = true}}, SHIFT(175),
  [421] = {.entry = {.count = 1, .reusable = true}}, SHIFT(103),
  [423] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_substitution_args, 4, 0, 24),
  [425] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_struct_init_repeat1, 2, 0, 0),
  [427] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_struct_init_repeat1, 2, 0, 0), SHIFT_REPEAT(173),
  [430] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_substitution_args_repeat1, 2, 0, 27),
  [432] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_substitution_args_repeat1, 2, 0, 27), SHIFT_REPEAT(175),
  [435] = {.entry = {.count = 1, .reusable = true}}, SHIFT(145),
  [437] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_path, 5, 0, 0),
  ...
  [447] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_args_list_repeat1, 2, 0, 0),
  [449] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_args_list_repeat1, 2, 0, 0), SHIFT_REPEAT(56),
  [452] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_struct_fields_repeat1, 5, 0, 0),
  [454] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_struct_init_repeat1, 4, 0, 0),
  [456] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_substitution_args_repeat1, 4, 0, 28),
  [458] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_param_list_repeat1, 4, 0, 0),
  [460] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_struct_fields_repeat1, 4, 0, 0),
  ...
  [552] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bracket_args, 1, 0, 0),
