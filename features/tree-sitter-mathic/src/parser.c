...
static const char * const ts_symbol_names[] = {
  ...
  [alias_sym_numeric_type] = "numeric_type",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [alias_sym_numeric_type] = alias_sym_numeric_type,
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_top_decl] = STATE(89),
    [sym_imports_decls] = STATE(110),
    [sym_func_decl] = STATE(110),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [68] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(200),
  ...
  [101] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_primary, 1, 0, 0), SHIFT(211),
  ...
  [108] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_path_repeat1, 2, 0, 0), SHIFT_REPEAT(196),
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 2, 0, 10),
  [113] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [115] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 2, 0, 10),
  ...
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 17),
  [127] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 17), SHIFT_REPEAT(32),
  [130] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 17),
  [132] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 17), SHIFT_REPEAT(124),
  [135] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 17), SHIFT_REPEAT(211),
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 1, 0, 5),
  [140] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 1, 0, 5),
  ...
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 3, 0, 19),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_call_expression_repeat1, 3, 0, 19),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 3, 0, 0),
  [158] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_call_expression_repeat1, 3, 0, 0),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 0),
  [162] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 0),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_primary, 3, 0, 0),
  [166] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_primary, 3, 0, 0),
  ...
  [188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_no_assign, 1, 0, 0),
  [190] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_no_assign, 1, 0, 0),
  [192] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_expression, 2, 0, 9),
  [194] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_expression, 2, 0, 9),
  [196] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 2, 0, 0),
  [198] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 2, 0, 0),
  [200] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_initializer, 1, 0, 0),
  ...
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_non_binary_expression, 1, 0, 0),
  [212] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_non_binary_expression, 1, 0, 0),
  [214] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_stmt, 3, 0, 12),
  [216] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_stmt, 3, 0, 12),
  [218] = {.entry = {.count = 1, .reusable = false}}, SHIFT(146),
  [220] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_func_decl, 6, 0, 7),
  [222] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func_decl, 6, 0, 7),
  [224] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_func_decl, 7, 0, 11),
  [226] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func_decl, 7, 0, 11),
  [228] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 1, 0, 0),
  [230] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 1, 0, 0),
  [232] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_stmt, 1, 0, 0),
  [234] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stmt, 1, 0, 0),
  [236] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_expression, 1, 0, 0), REDUCE(sym_expression_no_assign, 1, 0, 0),
  [239] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expr_stmt, 2, 0, 0),
  [241] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expr_stmt, 2, 0, 0),
  [243] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_return_stmt, 3, 0, 13),
  [245] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_return_stmt, 3, 0, 13),
  [247] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sym_decl, 5, 0, 20),
  [249] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sym_decl, 5, 0, 20),
  [251] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_for_stmt, 5, 0, 21),
  [253] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_for_stmt, 5, 0, 21),
  [255] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_stmt, 5, 0, 22),
  [257] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_stmt, 5, 0, 22),
  [259] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_var_decl, 7, 0, 23),
  [261] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_var_decl, 7, 0, 23),
  [263] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_for_stmt, 7, 0, 24),
  [265] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_for_stmt, 7, 0, 24),
  [267] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_struct_decl, 4, 0, 1),
  [269] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_decl, 4, 0, 1),
  [271] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_func_decl, 5, 0, 3),
  [273] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func_decl, 5, 0, 3),
  [275] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_struct_decl, 5, 0, 4),
  [277] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_decl, 5, 0, 4),
  [279] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_func_decl, 6, 0, 8),
  [281] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func_decl, 6, 0, 8),
  [283] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_while_stmt, 3, 0, 12),
  [285] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_while_stmt, 3, 0, 12),
  ...
  [297] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2, 0, 0), SHIFT_REPEAT(149),
  [300] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2, 0, 0), SHIFT_REPEAT(178),
  [303] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2, 0, 0), SHIFT_REPEAT(192),
  ...
  [316] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_init, 6, 0, 0),
  [318] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_initializer, 2, 0, 0),
  [320] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 3, 0, 14),
  [322] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_native_type, 1, 0, 0),
  [324] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__type, 4, 0, 0),
  [326] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 4, 0, 18),
  [328] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__type, 5, 0, 0),
  [330] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment_expression, 1, 0, 0),
  ...
  [342] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_assignment_repeat1, 2, 0, 0), SHIFT_REPEAT(211),
  [345] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_top_decl, 1, 0, 0),
  [347] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_imports_decls, 3, 0, 0),
  ...
  [359] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_path, 1, 0, 0),
  ...
  [369] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_struct_fields_repeat1, 2, 0, 0),
  [371] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_struct_fields_repeat1, 2, 0, 0), SHIFT_REPEAT(155),
  [374] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_import_path_repeat1, 2, 0, 0),
  [376] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_import_path_repeat1, 2, 0, 0), SHIFT_REPEAT(156),
  [379] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_list, 4, 0, 0),
  [381] = {.entry = {.count = 1, .reusable = true}}, SHIFT(195),
  [383] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_args_list, 2, 0, 0),
  ...
  [395] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_path, 3, 0, 0),
  [397] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_fields, 4, 0, 0),
  [399] = {.entry = {.count = 1, .reusable = true}}, SHIFT(102),
  [401] = {.entry = {.count = 1, .reusable = true}}, SHIFT(173),
  [403] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_args_list_repeat1, 2, 0, 0),
  [405] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_args_list_repeat1, 2, 0, 0), SHIFT_REPEAT(57),
  [408] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_substitution_args, 3, 0, 0),
  ...
  [418] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_substitution_args, 4, 0, 0),
  [420] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_path, 6, 0, 0),
  [422] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_struct_init_repeat1, 2, 0, 0),
  [424] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_struct_init_repeat1, 2, 0, 0), SHIFT_REPEAT(173),
  [427] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_substitution_args_repeat1, 2, 0, 0),
  [429] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_substitution_args_repeat1, 2, 0, 0), SHIFT_REPEAT(175),
  [432] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_args_list, 1, 0, 0),
  [434] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_list, 3, 0, 0),
  [436] = {.entry = {.count = 1, .reusable = true}}, SHIFT(125),
  [438] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_param_list_repeat1, 2, 0, 0),
  [440] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_param_list_repeat1, 2, 0, 0), SHIFT_REPEAT(195),
  [443] = {.entry = {.count = 1, .reusable = true}}, SHIFT(17),
  [445] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_fields, 5, 0, 0),
  [447] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_param_list_repeat1, 4, 0, 0),
  [449] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_struct_init_repeat1, 4, 0, 0),
  [451] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_substitution_args_repeat1, 4, 0, 0),
  [453] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_struct_fields_repeat1, 4, 0, 0),
  [455] = {.entry = {.count = 1, .reusable = false}}, SHIFT(172),
  [457] = {.entry = {.count = 1, .reusable = false}}, SHIFT(169),
  [459] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_struct_fields_repeat1, 5, 0, 0),
  ...
  [509] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bracket_args, 1, 0, 0),
