...
enum ts_symbol_identifiers {
  ...
  sym__type = 97,
  sym_native_type = 98,
  sym__path_identifier = 99,
  aux_sym_program_repeat1 = 100,
  aux_sym_block_repeat1 = 101,
  aux_sym_assignment_repeat1 = 102,
  aux_sym_call_expression_repeat1 = 103,
  aux_sym_struct_init_repeat1 = 104,
  aux_sym_substitution_args_repeat1 = 105,
  aux_sym_param_list_repeat1 = 106,
  aux_sym_struct_fields_repeat1 = 107,
  aux_sym_args_list_repeat1 = 108,
  aux_sym_import_path_repeat1 = 109,
  alias_sym_field_identifier = 110,
  alias_sym_path_identifier = 111,
...
static const char * const ts_symbol_names[] = {
  ...
  [sym__path_identifier] = "_path_identifier",
  ...
  [alias_sym_path_identifier] = "path_identifier",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym__path_identifier] = sym__path_identifier,
  ...
  [alias_sym_path_identifier] = alias_sym_path_identifier,
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(1)] = {
    ...
    [sym_top_decl] = STATE(91),
    [sym_imports_decls] = STATE(109),
    [sym_func_decl] = STATE(109),
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(112)] = 3786,
  [SMALL_STATE(113)] = 3796,
  [SMALL_STATE(114)] = 3808,
  [SMALL_STATE(115)] = 3822,
  ...
  [SMALL_STATE(154)] = 4277,
  [SMALL_STATE(155)] = 4287,
  [SMALL_STATE(156)] = 4295,
  ...
  [SMALL_STATE(197)] = 4592,
  [SMALL_STATE(198)] = 4599,
  [SMALL_STATE(199)] = 4606,
  [SMALL_STATE(200)] = 4613,
  [SMALL_STATE(201)] = 4620,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [47] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(7),
  [50] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(206),
  [53] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(43),
  [56] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(204),
  [59] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(6),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0),
  [64] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(161),
  [67] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(172),
  [70] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(202),
  [73] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(83),
  [76] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(82),
  [79] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(36),
  [82] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(88),
  [85] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(29),
  [88] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, 0, 0), SHIFT_REPEAT(29),
  [91] = {.entry = {.count = 1, .reusable = true}}, SHIFT(55),
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__path_identifier, 1, 0, 3),
  [95] = {.entry = {.count = 1, .reusable = false}}, SHIFT(34),
  [97] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__path_identifier, 1, 0, 3),
  [99] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__path_identifier, 1, 0, 3), SHIFT(187),
  ...
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 1, 0, 7),
  [110] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [112] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 1, 0, 7),
  [114] = {.entry = {.count = 1, .reusable = true}}, SHIFT(118),
  [116] = {.entry = {.count = 1, .reusable = false}}, SHIFT(187),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 19),
  [120] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 19), SHIFT_REPEAT(30),
  [123] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 19),
  [125] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 19), SHIFT_REPEAT(118),
  [128] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 19), SHIFT_REPEAT(187),
  [131] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 2, 0, 11),
  [133] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 2, 0, 11),
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_path, 1, 0, 5),
  [137] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_path, 1, 0, 5),
  [139] = {.entry = {.count = 1, .reusable = true}}, SHIFT(117),
  [141] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field_access, 2, 0, 17),
  [143] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_field_access, 2, 0, 17),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_primary, 3, 0, 0),
  [147] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_primary, 3, 0, 0),
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_path, 3, 0, 12),
  [151] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_path, 3, 0, 12),
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_primary, 1, 0, 0),
  [155] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_primary, 1, 0, 0),
  [157] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [159] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 3, 0, 21),
  [161] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_call_expression_repeat1, 3, 0, 21),
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 0),
  [165] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 0),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 3, 0, 0),
  [169] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_call_expression_repeat1, 3, 0, 0),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_expression, 2, 0, 10),
  [173] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_expression, 2, 0, 10),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_no_assign, 1, 0, 0),
  [177] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_no_assign, 1, 0, 0),
  [179] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_stmt, 3, 0, 14),
  ...
  [201] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 3, 0, 18),
  [203] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_initializer, 1, 0, 0),
  [205] = {.entry = {.count = 1, .reusable = true}}, SHIFT(190),
  [207] = {.entry = {.count = 1, .reusable = true}}, SHIFT(74),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_non_binary_expression, 1, 0, 0),
  [211] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_non_binary_expression, 1, 0, 0),
  ...
  [221] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_struct_decl, 5, 0, 6),
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_decl, 5, 0, 6),
  [225] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expr_stmt, 2, 0, 0),
  [227] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expr_stmt, 2, 0, 0),
  [229] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_declaration, 1, 0, 0),
  [231] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration, 1, 0, 0),
  [233] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_while_stmt, 3, 0, 14),
  [235] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_while_stmt, 3, 0, 14),
  [237] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_return_stmt, 3, 0, 15),
  [239] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_return_stmt, 3, 0, 15),
  [241] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_stmt, 1, 0, 0),
  [243] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stmt, 1, 0, 0),
  [245] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_expression, 1, 0, 0), REDUCE(sym_expression_no_assign, 1, 0, 0),
  [248] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sym_decl, 5, 0, 22),
  [250] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sym_decl, 5, 0, 22),
  [252] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_stmt, 5, 0, 24),
  [254] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_stmt, 5, 0, 24),
  [256] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_var_decl, 7, 0, 27),
  [258] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_var_decl, 7, 0, 27),
  [260] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_for_stmt, 7, 0, 28),
  [262] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_for_stmt, 7, 0, 28),
  [264] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_struct_decl, 4, 0, 1),
  [266] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_decl, 4, 0, 1),
  [268] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_func_decl, 5, 0, 4),
  [270] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func_decl, 5, 0, 4),
  [272] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_func_decl, 6, 0, 8),
  [274] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func_decl, 6, 0, 8),
  [276] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_func_decl, 6, 0, 9),
  [278] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func_decl, 6, 0, 9),
  [280] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_func_decl, 7, 0, 13),
  [282] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func_decl, 7, 0, 13),
  [284] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_for_stmt, 5, 0, 23),
  [286] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_for_stmt, 5, 0, 23),
  [288] = {.entry = {.count = 1, .reusable = false}}, SHIFT(20),
  [290] = {.entry = {.count = 1, .reusable = true}}, SHIFT(81),
  [292] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2, 0, 0),
  [294] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2, 0, 0), SHIFT_REPEAT(152),
  [297] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2, 0, 0), SHIFT_REPEAT(173),
  [300] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2, 0, 0), SHIFT_REPEAT(193),
  [303] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__type, 1, 0, 2),
  [305] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_program, 1, 0, 0),
  [307] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__type, 4, 0, 0),
  [309] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_native_type, 1, 0, 0),
  [311] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 3, 0, 16),
  [313] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_initializer, 2, 0, 0),
  [315] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression, 1, 0, 0),
  [317] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment_expression, 1, 0, 0),
  [319] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_init, 5, 0, 0),
  [321] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 4, 0, 20),
  [323] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_init, 6, 0, 0),
  [325] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_imports_decls, 3, 0, 0),
  ...
  [333] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_assignment_repeat1, 2, 0, 0),
  [335] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_assignment_repeat1, 2, 0, 0), SHIFT_REPEAT(187),
  ...
  [344] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_top_decl, 1, 0, 0),
  ...
  [364] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_list, 3, 0, 0),
  [366] = {.entry = {.count = 1, .reusable = true}}, SHIFT(207),
  [368] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_args_list, 2, 0, 0),
  [370] = {.entry = {.count = 1, .reusable = true}}, SHIFT(39),
  [372] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_fields, 4, 0, 0),
  [374] = {.entry = {.count = 1, .reusable = true}}, SHIFT(153),
  [376] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_fields, 3, 0, 0),
  [378] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_path, 6, 0, 0),
  [380] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_import_path_repeat1, 2, 0, 0),
  [382] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_import_path_repeat1, 2, 0, 0), SHIFT_REPEAT(144),
  [385] = {.entry = {.count = 1, .reusable = true}}, SHIFT(98),
  [387] = {.entry = {.count = 1, .reusable = true}}, SHIFT(169),
  [389] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_args_list_repeat1, 2, 0, 0),
  [391] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_args_list_repeat1, 2, 0, 0), SHIFT_REPEAT(39),
  [394] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_substitution_args, 3, 0, 25),
  ...
  [404] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_substitution_args, 4, 0, 26),
  [406] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_args_list, 1, 0, 0),
  [408] = {.entry = {.count = 1, .reusable = true}}, SHIFT(141),
  [410] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_struct_init_repeat1, 2, 0, 0),
  [412] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_struct_init_repeat1, 2, 0, 0), SHIFT_REPEAT(169),
  [415] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_substitution_args_repeat1, 2, 0, 29),
  [417] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_substitution_args_repeat1, 2, 0, 29), SHIFT_REPEAT(171),
  [420] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_param_list_repeat1, 2, 0, 0),
  [422] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_param_list_repeat1, 2, 0, 0), SHIFT_REPEAT(207),
  [425] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_struct_fields, 5, 0, 0),
  [427] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_struct_fields_repeat1, 2, 0, 0),
  [429] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_struct_fields_repeat1, 2, 0, 0), SHIFT_REPEAT(153),
  [432] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_path, 3, 0, 0),
  [434] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_path, 5, 0, 0),
  [436] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param_list, 4, 0, 0),
  [438] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [440] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_param_list_repeat1, 4, 0, 0),
  [442] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_struct_fields_repeat1, 4, 0, 0),
  [444] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_struct_fields_repeat1, 5, 0, 0),
  [446] = {.entry = {.count = 1, .reusable = false}}, SHIFT(188),
  [448] = {.entry = {.count = 1, .reusable = false}}, SHIFT(186),
  [450] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_struct_init_repeat1, 4, 0, 0),
  [452] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_substitution_args_repeat1, 4, 0, 30),
  ...
  [474] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bracket_args, 1, 0, 0),
