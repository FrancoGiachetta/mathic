...
use crate::{
    ...
    lowering::ir::{
        ...
        symbols::declaration_table::DeclTable,
        types::MathicType,
    },
...
impl SymbolTableBuilder {
    pub fn new(modules: Option<Vec<Arc<IrModule>>>) -> Self {
        Self {
            decl_table: match modules {
                Some(modules) => DeclTable::new(modules),
                None => DeclTable::default(),
            },
            ..Default::default()
        }
    }
