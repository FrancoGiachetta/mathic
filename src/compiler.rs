...
use crate::{
    ...
    diagnostics::{CodegenError, CompilationError, DiagnosticsManager},
    ffi::{
        self,
...
impl MathicCompiler {
    ...
    pub fn compile_project(
        ...
        let mut loader = ModuleLoader::new(&self.diagnostics);
        let compilation_unit = loader.load(src_root, PathBuf::from("main.mth"))?;
