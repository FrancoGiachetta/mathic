...
pub fn lower_top_level_ast_type(
    ...
    Ok(match ty {
        AstType::Type(name) => match name.as_str() {
            "isz" => ir_builder.get_or_insert_type_idx(MathicType::Numeric(NumericTy::Sint(SintTy::Isize))),
            "i8" => ir_builder.get_or_insert_type_idx(MathicType::Numeric(NumericTy::Sint(SintTy::I8))),
            "i16" => ir_builder.get_or_insert_type_idx(MathicType::Numeric(NumericTy::Sint(SintTy::I16))),
            "i32" => ir_builder.get_or_insert_type_idx(MathicType::Numeric(NumericTy::Sint(SintTy::I32))),
            "i64" => ir_builder.get_or_insert_type_idx(MathicType::Numeric(NumericTy::Sint(SintTy::I64))),
            "i128" => ir_builder.get_or_insert_type_idx(MathicType::Numeric(NumericTy::Sint(SintTy::I128))),
            "usz" => ir_builder.get_or_insert_type_idx(MathicType::Numeric(NumericTy::Uint(UintTy::Usize))),
            "u8" => ir_builder.get_or_insert_type_idx(MathicType::Numeric(NumericTy::Uint(UintTy::U8))),
            "u16" => ir_builder.get_or_insert_type_idx(MathicType::Numeric(NumericTy::Uint(UintTy::U16))),
            "u32" => ir_builder.get_or_insert_type_idx(MathicType::Numeric(NumericTy::Uint(UintTy::U32))),
            "u64" => ir_builder.get_or_insert_type_idx(MathicType::Numeric(NumericTy::Uint(UintTy::U64))),
            "u128" => ir_builder.get_or_insert_type_idx(MathicType::Numeric(NumericTy::Uint(UintTy::U128))),
